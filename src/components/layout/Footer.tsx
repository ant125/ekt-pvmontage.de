...
export default function Footer() {
  return (
    <footer className="border-t border-zinc-200 bg-white">
      <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col gap-3 items-center text-center md:flex-row md:justify-between md:gap-0 md:text-left text-sm text-zinc-600">
