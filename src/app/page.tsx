  ...
  return (
    <main className="bg-white text-zinc-800">
      <section className="fade-up relative overflow-x-clip overflow-y-visible bg-zinc-50 min-h-[88vh]">
        ...
        <div className="mx-auto grid max-w-6xl items-stretch gap-10 px-6 pb-10 pt-6 md:grid-cols-2 md:gap-12 md:pb-12 md:pt-8">
          ...
          <div className="relative z-10 -mr-2 flex min-h-[min(58vh,520px)] w-full flex-col items-end justify-start sm:-mr-3 md:min-h-0 md:h-full md:-mr-6 md:pl-2 lg:-mr-10">
            <img
              src="/hero-worker.png"
              alt="Besik Gigauri – Photovoltaik-Montage"
              className="h-full max-h-full w-auto max-w-full object-contain object-right object-top drop-shadow-[0_28px_60px_rgba(0,0,0,0.22)] md:max-w-[min(96vw,720px)] md:translate-x-3 lg:translate-x-8"
            />
          </div>
        </div>
      </section>
