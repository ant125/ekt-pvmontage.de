  ...
  return (
    <main className="bg-white text-zinc-800">
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="mx-auto w-full max-w-6xl px-6">
            <div className="max-w-3xl text-white">
              ...
              <a
                href="#kontakt"
                className="mt-8 inline-flex items-center rounded-md bg-white px-6 py-3 text-sm font-medium text-zinc-900 transition hover:bg-zinc-100"
              >
                Kontakt aufnehmen
              </a>
            </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <a
          href="/projekte"
          className="mt-10 inline-flex rounded-md border border-zinc-300 px-6 py-3 text-sm font-medium text-zinc-800 hover:bg-zinc-100"
        >
      ...
      <section id="kontakt" className="bg-zinc-50 py-16">
        <div className="mx-auto grid max-w-6xl gap-10 px-6 md:grid-cols-2">
          ...
          <form className="rounded-xl border border-zinc-200 bg-white p-6">
            ...
            <button
              type="submit"
              className="mt-5 inline-flex rounded-md bg-zinc-900 px-6 py-3 text-sm font-medium text-white hover:bg-zinc-800"
            >
              Nachricht senden
            </button>
          </form>
